...
int main()
{
    ...
    std::string participantsFile="ParticipantsListMatLab.txt"; //Obligatory file with names (first and last) and a boolean value, which is Yes: if the person wants to participate
    ...
    listOfPersonByGroup.writeOutputFile(outputFile);
    return 0;
}
